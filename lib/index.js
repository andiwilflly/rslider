...
/******/ 	var hotCurrentHash = "5fae19b3c02a6b042803"; // eslint-disable-line no-unused-vars
	...
	function RSliderDraggable() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSliderDraggable.__proto__ || Object.getPrototypeOf(RSliderDraggable)).call.apply(_ref, [this].concat(args))), _this), _this.draggable = {
			...
			move: function move(e) {
				...
				if (_this.draggable.dragIterationsCounter === 5 && Math.abs(_this.draggable.realStartX - _this.draggable.x) <= 40) {
					console.log('IS-VERTICAL');
					return _this.draggable.stop();
				} else {
