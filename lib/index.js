...
/******/ 	var hotCurrentHash = "b9bc42a7f4e8f1043078"; // eslint-disable-line no-unused-vars
...
var RSlider = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_RSliderBasic) {
	...
	_createClass(RSlider, [{
		...
		value: function componentWillUnmount() {
			...
			setTimeout(function () {
				return _rSlider2.default.remove({ name: _this3.slider.name });
			}, 200);
		}
			...
			return _react2.default.createElement(
				...
				this.slider && this.slider.devMode ? _react2.default.createElement(
					...
					Object.keys(this.slider).map(function (name) {
						var prop = _this4.slider[name];
						return _react2.default.createElement(
							'p',
							{ key: name },
							name,
							': ',
							prop instanceof Object || prop instanceof Function || name === 'children' ? '[ content ]' : JSON.stringify(_this4.slider[name])
						);
					})
				) : null
			);
	...
	function RSliderDraggable() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSliderDraggable.__proto__ || Object.getPrototypeOf(RSliderDraggable)).call.apply(_ref, [this].concat(args))), _this), _this.draggable = {
			...
			start: function start() {
				...
				_this.draggable.realStartX = _this.draggable.x;
			...
			move: function move(e) {
				...
				if (_this.draggable.dragIterationsCounter === 10 && Math.abs(_this.draggable.realStartX - _this.draggable.x) <= 30) return _this.draggable.stop();

				_this.draggable.dragIterationsCounter += 1;
			...
			stop: function stop() {
				...
				_this.draggable.dragIterationsCounter = false;
