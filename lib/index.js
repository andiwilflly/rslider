...
/******/ 	var hotCurrentHash = "64f10c057d4c394f2d19"; // eslint-disable-line no-unused-vars
					...
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 4:
								...
								this.rSliders.set(state.name, _extends({}, rSlider, { customAnimationStatus: 'started' }));
								_context.next = 10;
							...
							case 10:
								...
								this.rSliders.set(state.name, _extends({}, rSlider, state));
								this.rSliders.set(state.name, _extends({}, rSlider, {
								...
								this.rSliders.set(state.name, _extends({}, rSlider, { customAnimationStatus: 'running' }));
								_context.next = 16;
								return this.delay(this.slides.customAnimationDuration(rSlider));

							case 16:
								this.rSliders.set(state.name, _extends({}, rSlider, { customAnimationStatus: 'disabled' }));
