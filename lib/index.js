(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("mobx"), require("mobx-react"), require("prop-types"));
	else if(typeof define === 'function' && define.amd)
		define(["mobx", "mobx-react", "prop-types"], factory);
	else if(typeof exports === 'object')
		exports["rslider"] = factory(require("mobx"), require("mobx-react"), require("prop-types"));
	else
		root["rslider"] = factory(root["mobx"], root["mobx-react"], root["prop-types"]);
...
/******/ 	}
/******/ 	var parentHotUpdateCallback = this["webpackHotUpdaterslider"];
/******/ 	this["webpackHotUpdaterslider"] = 
...
/******/ 	var hotCurrentHash = "950e218bfc19b8be2ef5"; // eslint-disable-line no-unused-vars
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // MobX
...
var _rSlider = __webpack_require__(3);
...
var RSliderBasic = (_class = function (_React$Component) {
	...
	function RSliderBasic() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSliderBasic.__proto__ || Object.getPrototypeOf(RSliderBasic)).call.apply(_ref, [this].concat(args))), _this), _this._lastMatchedMediaName = null, _this._timeout = {
			...
			if (_this.slider.media) _this.detectMediaMatch();
			...
			_this._timeout['detectMediaMatch'] = setTimeout(function () {
				...
				L('this._lastMatchedMediaName', _this._lastMatchedMediaName);
...
var _RSlider = __webpack_require__(7);

var _RSlider2 = _interopRequireDefault(_RSlider);

var _RSliderItems = __webpack_require__(8);

var _RSliderItems2 = _interopRequireDefault(_RSliderItems);

var _RSliderArrowL = __webpack_require__(11);

var _RSliderArrowL2 = _interopRequireDefault(_RSliderArrowL);

var _RSliderArrowR = __webpack_require__(12);

var _RSliderArrowR2 = _interopRequireDefault(_RSliderArrowR);

var _RSliderPagination = __webpack_require__(13);
	...
	_createClass(RSlider, [{
		...
		value: function componentDidMount() {
			...
			this['RSlider | changed: this.slider.currentStep | run: this.slider.onStepChange()'] = (0, _mobx.reaction)(function () {
				return _this2.slider.currentStep;
			}, function () {
				return _this2.slider.onStepChange(_this2.slider);
		...
		value: function componentWillUnmount() {
			...
			_rSlider2.default.remove({ name: this.slider.name });
		}
			...
			return React.createElement(
				...
				React.createElement(
					...
					{ className: 'rslider ' + (this.slider ? this.slider.className : ''),
						ref: 'rSlider',
						style: this.slider ? _extends({}, this.slider.style, {
							width: '100%',
							boxSizing: 'content-box',
							paddingRight: this.props.stickOut + 'px' }) : { paddingRight: this.props.stickOut + 'px' } },
					this.slider ? this.props.children : null
				),
				this.slider && this.slider.devMode ? React.createElement(
					'ul',
...
var _RSliderDraggable = __webpack_require__(9);

var _RSliderDraggable2 = _interopRequireDefault(_RSliderDraggable);

var _RSliderItem = __webpack_require__(10);
	...
	_createClass(RSliderItems, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				this.slider.draggable ? React.createElement(
					_RSliderDraggable2.default,
					null,
					this.renderSliderItems()
				) : this.isCustomAnimationEffect ? React.createElement(
					_RSliderItem2.default,
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSliderDraggable.__proto__ || Object.getPrototypeOf(RSliderDraggable)).call.apply(_ref, [this].concat(args))), _this), _this.draggable = {
			...
			move: function move(e) {
				if (_this.isTouchDevice) {
					...
					_this.draggable.x = document.all ? window.event["clientX"] : e["pageX"];
				}
			...
			remove: function remove() {
				if (_this.isTouchDevice) {
					...
					document.removeEventListener('touchmove', _this.draggable.move);
	...
	_createClass(RSliderItem, [{
		...
		value: function componentDidMount() {
			...
			this['RSliderItem | changed: rSliderModel.currentStep | run: this.startItemAutoPlayInterval()'] = (0, _mobx.reaction)(function () {
				return _this2.slider.currentVisibleItems[0] === _this2.props.itemIndex;
			}, function () {
				return _this2.isAutoPlay ? _this2.startItemAutoPlayInterval() : clearTimeout(_this2.timer);
			}, {
		...
		key: 'duration',
		get: function get() {
			return this.props.children.props ? this.props.children.props['data-duration'] || 5000 : null;
		}
	}, {
			...
			return React.createElement(
				...
				new Array(_rSlider2.default.steps.all(this.slider)).fill(undefined).map(function (value, step) {
					return React.createElement(
						...
						_this2.props.children ? _this2.props.children[step] || React.createElement(
							'button',
