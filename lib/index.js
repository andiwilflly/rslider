...
/******/ 	var hotCurrentHash = "ad2a0bfc41f675f59ee5"; // eslint-disable-line no-unused-vars
					...
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 4:
								...
								rSlider = _extends({}, rSlider, { customAnimationStatus: 'started' });
								_context.next = 10;
							...
							case 10:
								...
								rSlider = _extends({}, rSlider, state);
								rSlider = _extends({}, rSlider, {
								...
								rSlider = _extends({}, rSlider, { customAnimationStatus: 'running' });
								_context.next = 16;
								return this.delay(this.slides.customAnimationDuration(rSlider));

							case 16:
								rSlider = _extends({}, rSlider, { customAnimationStatus: 'disabled' });
