...
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_5__) {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	function hotDisposeChunk(chunkId) {
/******/ 		delete installedChunks[chunkId];
/******/ 	}
/******/ 	var parentHotUpdateCallback = window["webpackHotUpdaterSliderLib"];
/******/ 	window["webpackHotUpdaterSliderLib"] = 
...
/******/ 	var hotCurrentHash = "281118b5328b3713392b"; // eslint-disable-line no-unused-vars
...
var RSliderModel = function () {
	...
	_createClass(RSliderModel, [{
		key: 'slider',
		value: function slider(name) {
			return this.rSliders.get(name);
		}
	}, {
		key: 'create',
		value: function create(state) {
			...
			if (!state.name) return (0, _mobx.runInAction)('\uD83E\uDD84-SLIDER-CREATE-ERROR name is ' + state.name, function () {});
			(0, _mobx.runInAction)('\uD83E\uDD84-SLIDER-CREATE-' + (this.rSliders.has(state.name) ? 'ERROR (already exists)' : 'SUCCESS') + '-' + state.name, function () {
				if (_this.rSliders.has(state.name)) _this.remove({ name: state.name });
				...
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								if (!this.slider(state.name)) (0, _mobx.runInAction)('\uD83E\uDD84-SLIDER-UPDATE-ERROR (no such slider) ' + state.name, function () {});

								// Disable [rSlider] when [rSlider.customAnimation] is running

								if (!(this.slider(state.name).customAnimationStatus !== 'disabled')) {
									_context.next = 3;
									break;
								}
							...
							case 3:
								...
								this.rSliders.set(state.name, _extends({}, this.slider(state.name), {
									customAnimationStatus: 'started'
								}));
								_context.next = 9;
								return this.delay(this.slides.customAnimationDuration(this.slider(state.name)) / 1.3);

							case 9:

								// Extend [state] with [rSlider]
								this.rSliders.set(state.name, _extends({}, this.slider(state.name), state));
								this.rSliders.set(state.name, _extends({}, this.slider(state.name), {
								...
								_context.next = 15;
								return this.delay(this.slides.customAnimationDuration(this.slider(state.name)));
		...
		value: function remove(_ref2) {
			...
			if (!name) (0, _mobx.runInAction)('\uD83E\uDD84-SLIDER-REMOVE-\'ERROR (no such slider name: ' + name + ')\' }', function () {});
	...
	function RSliderBasic() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSliderBasic.__proto__ || Object.getPrototypeOf(RSliderBasic)).call.apply(_ref, [this].concat(args))), _this), _this._lastMatchedMediaName = null, _this._timeout = {
			...
			_this._timeout['recalculateSliderItems'] = setTimeout(function () {
				...
				var itemWidth = _this.getElementPureWidth(_this.slider.sliderEl) / _this.slider.itemsShow; // item width always the same (even for [isShortSlider])
...
var RSlider = (0, _mobxReact.observer)(_class = (_temp2 = _class2 = function (_RSliderBasic) {
	...
	function RSlider() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSlider.__proto__ || Object.getPrototypeOf(RSlider)).call.apply(_ref, [this].concat(args))), _this), _this.rSliderRef = _react2.default.createRef(), _this.mouseEnter = function () {
...
var RSliderDraggable = (0, _mobxReact.observer)(_class = (_temp2 = _class2 = function (_RSliderBasic) {
	...
	function RSliderDraggable() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSliderDraggable.__proto__ || Object.getPrototypeOf(RSliderDraggable)).call.apply(_ref, [this].concat(args))), _this), _this.rSliderDraggableRef = _react2.default.createRef(), _this.draggable = {
			x: 0,
			y: 0,
			startX: 0,
			...
			stop: function stop() {
				...
				if (_this.draggable.moveCounter > 1) {
					_rSlider2.default.update({
						name: _this.slider.name,
	...
	_createClass(RSliderDraggable, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'div',
				{ className: 'rslider__track', ref: this.rSliderDraggableRef, style: {
						width: this.slider.innerWidth,
						left: this.slider.leftPosition
					} },
				this.props.children
	...
	_createClass(RSliderItem, [{
		...
		value: function startItemAutoPlayInterval() {
			...
			this.timer = setTimeout(function () {
				...
				if (_this3.slider.isDraggableMouseEnter) {
					console.info('[rSlider ' + _this3.slider.name + ' hovered: AutoPlay stopped...] (duration: ' + _this3.duration + ')');
					return _this3.startItemAutoPlayInterval();
				}
				_rSlider2.default.update({
