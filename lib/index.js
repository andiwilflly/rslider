...
/******/ 	var hotCurrentHash = "5a76d86e629e668088aa"; // eslint-disable-line no-unused-vars
	...
	function RSliderDraggable() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = RSliderDraggable.__proto__ || Object.getPrototypeOf(RSliderDraggable)).call.apply(_ref, [this].concat(args))), _this), _this.draggable = {
			...
			init: function init(el) {
				...
				_this.draggable.el.addEventListener('mouseenter', _this.draggable.enter, false);
				_this.draggable.el.addEventListener('mouseleave', _this.draggable.leave, false);
			...
			remove: function remove() {
				...
				_this.draggable.el.removeEventListener('touchmove', _this.draggable.move);
				_this.draggable.el.removeEventListener('mouseenter', _this.draggable.enter);
				_this.draggable.el.removeEventListener('mouseleave', _this.draggable.leave);
